...
public class Main {
    ...
    public static void main(String[] args){
        ...
        Gladiator player1 = new Gladiator("Ken", 100, 0, rand.nextInt(25) + 20, rand.nextInt(8) + 3);
        Gladiator player2 = new Gladiator("Ryu", 100, 0, rand.nextInt(25) + 20, rand.nextInt(8) + 3);
